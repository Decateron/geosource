...
// Returns true if the requester has permission to view the favorites of the
// given user, false otherwise. Returns an error if a result cannot be
// determined.
func CanViewFavorites(requester, userID string) (bool, error) {
	return requester == userID, nil
}

// Returns true if the requester has permission to modify the favorites of the
// given user, false otherwise. Returns an error if a result cannot be
// determined.
...
// Adds the given post to the set of favorites for the user with ID userID. This
...
// Returns the set of favorites for the user with ID userID. This transaction is
// executed under the permission level of the requester. Returns an error if the
// requester does not have sufficient permission, or if some other error occurs
// within the database.
...
// Removes the given post from the user with ID userID's set of favorites. This
// transaction is executed under the permission level of the requester. Returns
// an error if the requester does not have sufficient permission, or if some
// other error occurs within the database.
